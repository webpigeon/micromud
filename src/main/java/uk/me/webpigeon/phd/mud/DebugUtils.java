...
public class DebugUtils {
	...
	public static void populateWorld(WorldModel world) {
		...
		blacksmith.setDescription(
				"A hot, smoke filled room with a roaring furance placed promently in its center. To the left of the furnace you see a large metal anvil.");
