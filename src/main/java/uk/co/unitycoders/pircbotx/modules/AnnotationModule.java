...
public class AnnotationModule implements Module {
	 ...
	 * 
	 * This is the constructor which subclasses should use. It will
	 * automatically register the methods which the subclass has tagged with the
	 * command interface.
	 */
	 ...
	 * 
	 * This is the constructor which allows classes with command annotations
	 * with does not implement the Module interface. This was the case for all
	 * plugins which are part of uc_pircbotx 0.2 or earlier, but presents
	 * problems for dynamic loading.
	 * 
	 * @param source
	 *            the class which should be wrapped.
	 */
